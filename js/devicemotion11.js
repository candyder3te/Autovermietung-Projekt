if (window.DeviceOrientationEvent) {
    document.getElementById("doeSupported").innerText = "OK - Device Rotation wird unterstützt!";
    window.addEventListener('devicemotion11', function(event) {
    ...
    document.getElementById("doeSupported").innerText = "Device Rotation wird nicht unterstützt!";
}